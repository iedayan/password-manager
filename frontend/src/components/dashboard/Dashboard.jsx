  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm relative z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
          <div className="flex justify-between items-center py-3 sm:py-4">
            ...
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 32 32">
              ...
              <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">
                Lok
              </h1>
            </button>
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="hidden sm:flex items-center gap-3">
                <button
                  ...
                  className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 hover:from-purple-700 hover:to-pink-700 transition-all shadow-md hover:shadow-lg font-medium text-sm"
                >
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 hover:from-emerald-700 hover:to-teal-700 transition-all shadow-md hover:shadow-lg font-medium text-sm"
                >
                ...
                <button
                  ...
                  className="bg-blue-600 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-colors font-medium text-sm"
                >
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {showSettingsDropdown && (
                  <div className="fixed right-2 sm:right-6 top-16 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-[9999]">
      ...
      <div className="max-w-7xl mx-auto p-3 sm:p-6">
        ...
        <div className="bg-slate-800/95 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-2xl border border-slate-700/60 p-4 sm:p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {activeTab === 'generator' && (
              <div className="w-full max-w-3xl mx-auto password-generator">
                <PasswordGenerator />
              </div>
            )}
            {activeTab === 'settings' && <Settings />}
            {activeTab === 'security' && (
              <div className="w-full max-w-5xl mx-auto security-dashboard">
                <SecurityDashboard 
                  passwords={passwords} 
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
        <button
          onClick={() => setShowAddForm(true)}
          className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-colors flex items-center justify-center group"
          title="Add Password"
        >
